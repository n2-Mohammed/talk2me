...
public class HomeActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		setTitle("Talk2Me App");
		4.setTabCount( );
		viewpager1.setAdapter(4);
		bottomnavigation1.getMenu().add(0, 0, 0, "Chat").setIcon(R.drawable.cha);
		bottomnavigation1.getMenu().add(0, 1, 0, "Status").setIcon(R.drawable.syste);
		bottomnavigation1.getMenu().add(0, 2, 0, "Contact").setIcon(R.drawable.contact);
		bottomnavigation1.getMenu().add(0, 3, 0, "More").setIcon(R.drawable.fffed);
	...
	public void _toolbarMenu() {
	 ...
	 @Override public boolean onOptionsItemSelected(final MenuItem item){ 
		switch (item.getTitle().toString()) {
			...
			t1.setText("Create A Status");
			t2.setText("Join Millions today");
			...
			_rippleRoundStroke(b2, "#30475e", "#40FFFFFF", 15, 0, "#000000");
			...
			b2.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					c.setClass(getApplicationContext(), StatusCreateActivity.class);
					startActivity(c);
					dialog.dismiss();
				}
			});
